...
const mysql = safeRequire("mysql",
    "Error: Could not load 'mysql', did you run 'npm install'?");
const config = safeRequire("./config.json", "Error: Could not load 'config.json'");
const users = safeRequire("./users.json", "Error: Could not load 'users.json'");
